...
| pf-runner/pf_parser.py | 1,924 | ✅ Core parser logic (complex domain) |
...
- **Grammar/Parser Tests:** 11 failures out of 145 tests (92% pass rate)
...
**Recommendations:**
- Review and fix the failing edge cases in grammar/parser tests
